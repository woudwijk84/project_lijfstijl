...
class Mini_Gallery_Widget extends WP_Widget {
	...
	function Mini_Gallery_Widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'gallery', 'description' => __('NorthVantage Widget Image/Text gallery, use posts or a gallery slide set.','themeva') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 320, 'height' => 350, 'id_base' => 'gallery-widget' );

		/* Create the widget. */
		$this->WP_Widget( 'gallery-widget', __('NorthVantage Widget Gallery','themeva'), $widget_ops, $control_ops );
	}
...
class nv_contact_form extends WP_Widget {
	...
	function nv_contact_form() {
		...
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'contact_form', 'description' => __('NorthVantage Contact Form.','themeva') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 320, 'height' => 350, 'id_base' => 'contactform-widget' );

		/* Create the widget. */
		$this->WP_Widget( 'contactform-widget', __('NorthVantage Contact Form','themeva'), $widget_ops, $control_ops );
	}
