    ...
    <form method="post" action="options.php" id="fuse_social_form">
        ...
        <div id="awesome_settings">
            ...
            foreach ($style_options as $option) {
                ...
                <label class="awesome_description"><input type="radio" name="fuse_social_options[style_input]"
                                                          value="<?php
                ...
                <table>
                    ...
                    <tr style="height:45px;">
                        ...
                        <td style="width: 300px;">
                            ...
                            <input id="fuse_social_options[linksnewtab]" name="fuse_social_options[linksnewtab]"
                            ...
                            <label class="awesome_description"
                                   for="fuse_social_options[linksnewtab]"><strong><?php _e("Open links new tab.", "fuse_social"); ?></strong></label>
                        ...
                        <td>
                            ...
                            <input id="fuse_social_animate" name="fuse_social_options[animations]" type="checkbox"
                                   value="1" <?php
                            ...
                            <label class="awesome_description"
                                   for="fuse_social_animate"><strong><?php _e("Animation on hover", "fuse_social"); ?> </strong></label>
                            ...
                            ?>" name="fuse_social_options[animate_sec]" type="text" placeholder="Delay in Seconds"
                                   style="width:250px;"/>

                            <span
                                id="fuse_social_options_anim_s"><em><?php _e("Animation delay in seconds. For-example 0.5", "fuse_social") ?></em></span>
                    ...
                    <tr style="height:45px;">
                        ...
                        <td>
                            ...
                            <input id="fuse_social_options[shadow]" name="fuse_social_options[shadow]" type="checkbox"
                                   value="1" <?php
                            ...
                            <label class="awesome_description"
                                   for="fuse_social_options[shadow]"><strong><?php _e("Don't use shadow in icons.", "fuse_social"); ?></strong></label>
                        ...
                        <td>
                            ...
                            <input id="fuse_social_options[mobile]" name="fuse_social_options[mobile]" type="checkbox"
                                   value="1" <?php
                            ...
                            <label class="awesome_description"
                                   for="fuse_social_options[mobile]"><strong><?php _e("Don't show in Mobile Version", "fuse_social"); ?></strong></label>
                        ...
                        <td style="padding-top:8px;">
                            ...
                            <label class="description"
                                   for="fuse_social_options[size]"><?php _e('<strong>Size</strong>', 'fuse_social'); ?></label>
                    ...
                    <tr>
                        <td>
                            ...
                            <label class="samecolor"
                                   for="fuse_social_options[colorpicker]"><strong><?php _e("Use custom background color for all icons.", "fuse_social"); ?></strong></label>
                        ...
                        <td>
                            ...
                            <input id="fuse_social_options[hover]" name="fuse_social_options[hover]" type="checkbox"
                                   value="1" <?php
                            ...
                            <label class="awesome_description"
                                   for="fuse_social_options[hover]"><strong><?php _e("Change icon color on hover - For Custom Background", "fuse_social"); ?></strong></label>
            ...
            <table id="icons">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <i class="fa fa-facebook"></i><label for="fuse_social_options[facebook]">
                            Facebook</label><br/><input id="fuse_social_options[facebook]" value="<?php
                    ...
                    <td>
                        ...
                        <i class="fa fa-twitter"></i><label for="fuse_social_options[twitter]">
                            Twitter</label><br/><input id="fuse_social_options[twitter]" value="<?php
                    ...
                    <td>
                        ...
                        <i class="fa fa-rss"></i><label for="fuse_social_options[rss]"> Rss</label><br/><input
                            id="fuse_social_options[rss]" value="<?php
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <i class="fa fa-linkedin"></i><label for="fuse_social_options[linkedin]">
                            Linkedin</label><br/><input id="fuse_social_options[linkedin]" value="<?php
                    ...
                    <td>
                        ...
                        <i class="fa fa-youtube"></i><label for="fuse_social_options[youtube]">
                            Youtube</label><br/><input id="fuse_social_options[youtube]" value="<?php
                    ...
                    <td>
                        ...
                        <i class="fa fa-flickr"></i><label for="fuse_social_options[flickr]"> Flickr</label><br/><input
                            id="fuse_social_options[flickr]" value="<?php
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <i class="fa fa-pinterest"></i><label for="fuse_social_options[pinterest]">
                            Pinterest</label><br/><input id="fuse_social_options[pinterest]" value="<?php
                    ...
                    <td>
                        ...
                        <i class="fa fa-stumbleupon"></i><label for="fuse_social_options[stumbleupon]">
                            Stumbleupon</label><br/><input id="fuse_social_options[stumbleupon]" value="<?php
                    ...
                    <td>
                        ...
                        <i class="fa fa-google-plus"></i><label for="fuse_social_options[google-plus]"> Google
                            Plus</label><br/><input id="fuse_social_options[google-plus]" value="<?php
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <i class="fa fa-instagram"></i><label for="fuse_social_options[instagram]">
                            Instagram</label><br/><input id="fuse_social_options[instagram]" value="<?php
                    ...
                    <td>
                        ...
                        <i class="fa fa-tumblr"></i><label for="fuse_social_options[tumblr]"> Tumblr</label><br/><input
                            id="fuse_social_options[tumblr]" value="<?php
                    ...
                    <td>
                        ...
                        <i class="fa fa-vine"></i><label for="fuse_social_options[vine]"> Vine</label><br/><input
                            id="fuse_social_options[vine]" value="<?php
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <i class="fa fa-vk"></i><label for="fuse_social_options[vk]"> VK</label><br/><input
                            id="fuse_social_options[vk]" value="<?php
                    ...
                    <td>
                        ...
                        <i class="fa fa-soundcloud"></i><label for="fuse_social_options[soundcloud]"> Sound
                            Cloud</label><br/><input id="fuse_social_options[soundcloud]" value="<?php
                    ...
                    <td>
                        ...
                        <i class="fa fa-reddit"></i><label for="fuse_social_options[reddit]"> Reddit</label><br/><input
                            id="fuse_social_options[reddit]" value="<?php
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <i class="fa fa-stack-overflow"></i><label for="fuse_social_options[stack]"> Stack
                            OverFLow</label><br/><input id="fuse_social_options[stack]" value="<?php
                    ...
                    <td>
                        ...
                        <i class="fa fa-behance"></i><label for="fuse_social_options[behance]">
                            Behance</label><br/><input id="fuse_social_options[behance]" value="<?php
                    ...
                    <td>
                        ...
                        <i class="fa fa-github"></i><label for="fuse_social_options[github]"> Github</label><br/><input
                            id="fuse_social_options[github]" value="<?php
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <i class="fa fa-envelope-o"></i><label for="fuse_social_options[envelope]">
                            Email</label><br/><input id="fuse_social_options[envelope]" value="<?php
        ...
        <p>Made With Love - By (<a href="https://www.facebook.com/mewoooooo" target="_blank">Daniyal Ahmed</a>).</p>
        <br/>
